  ...
  Widget bottomBar() {
    return Consumer3<IsUserExitsController, Bookingedite, pakagecontrollers>(
        builder: (context, user,  booking, pkg, child) {
          ...
          return InkWell(
            onTap: (){
              booking.Uploaduserdocs(sessiontoken:user.isUser?.sessionToken,bookingnumber: booking.booking?.bookingNumber,amount: booking.booking?.packageCost).then((value) {
                if(value == true){
                  endLoading();
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                child: SizedBox(
                                  ...
                                  child: _image == null
                                    ...
                                    children: [
                                      ...
                                      customFonts(
                                          text: "Upload snapshot of Passport and ID",
                                          size: 17,
                          ...
                          booking.imageFileList.isEmpty?Container(): Container(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder:(context,index){
                                  isImageSizeValid(booking.imageFileList![index].path);
                                  return Padding(
                                            ...
                                            children: [
                                              ClipRRect(
                                                ...
                                                child: AspectRatio(
                                                  ...
                                                  child: Image.file(
                                                    File(booking.imageFileList![index].path),
                                                    fit: BoxFit.cover,
                                                  ),
                                                ),
                                              ),
                                              ...
                                              isshown?customFonts(text: 'Exceeds more then 2 mb ', size: 16, context: context,fontWeight: FontWeight.bold,color: Color(0xffFCDDDD)):customFonts(text: booking.imageFileList![index].name, size: 16, context: context,fontWeight: FontWeight.bold),
                                              Spacer(),
                                              InkWell(
                                                onTap: (){
                                                  booking.imageFileList.removeAt(index);
                                                  booking.filePaths.removeAt(index);
                                                  booking.notifyListeners();
                                                },
                                                child: SvgPicture.asset(
                                                  'images/delete.svg',
