...
import '../View/TransportPageWidgets/View/Transport.dart';
import '../View/auth/view/sign_up_with_mobile_number/signup_with_number.dart';
import '../View/wishlist/view/wishlist.dart';
import '../View/Home/widgets/Searchwidget.dart';

class HomeScreenNew extends StatefulWidget {
  int selectedIndex;

  HomeScreenNew({super.key, this.selectedIndex = 0});
...
Widget recommendedPackages(
  ...
  return Column(
    ...
    children: [
      ...
      SizedBox(
        height: responsive(190, context),
        child:  pageViewCLass(length, image, package, startDate, endDate, pageController, amount),
      ),
//
//       // SizedBox(
...
Widget pageViewCLass(length, image, packagecontroller, startDate, endDate,pageController , amount) {
